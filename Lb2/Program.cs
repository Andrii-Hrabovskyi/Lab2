...
namespace Lb2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Employee employee = new Employee("Stepan", "Bandera");
    ...
    class Converter
    {
        ...
        public void ConvertChooseStart()
        {
            ...
            do
            {
                Console.WriteLine("Choose: 1 - UAH to USD/EUR/RUB, 2 - USD/EUR/RUB to UAH: \nPress 0 to exit");
    ...
    class User
    {
        ...
        private string login = "OUNR";
        private string name = "Stepan";
        private string forname = "Bandera";
        private int age = 50;
